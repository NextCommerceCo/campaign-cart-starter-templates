...
Templates follow SDK **0.4.x** patterns (`apollo`, `apollo-mv-single-step`, `olympus`, `olympus-mv-single-step`, `olympus-mv-two-step`, `limos`, `demeter`, `shop-single-step`, `shop-three-step` today). **`apollo`** is the flagship single-step checkout family; **`apollo-mv-single-step`** is the flagship MV family.
