...
| `bump-check03.html` | **all checkout template families** (shared unsynced product-card bump with optional PackageToggle line-item property field) |
