...
**SDK:** Pin `sdk_version` in `_data/campaigns.json` (e.g. `0.4.18` for **`olympus`** in the reference file — match [`campaign-kit-templates/_data/campaigns.json`](../campaign-kit-templates/_data/campaigns.json)).  
