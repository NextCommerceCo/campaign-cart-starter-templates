...
|--------|----------------|---------|
| **Load** | Each card: image + `package.name`; per-unit / compare / totals via `data-next-bundle-price` / `data-next-bundle-display`; **`data-next-bundle-price="total"`** (not bare) shows a number on every tier. | BS-003, BS-006 — *verified 2026-04-01* |
...
Then update **`docs/olympus-v0.4.0-bundle-selector-bug-log.md`** statuses and one-line verification notes.
