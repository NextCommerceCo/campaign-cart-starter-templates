...
*Last aligned with the template bug log: BS-001–BS-018 and operator/platform notes. SDK 0.4.11: BS-012 fixed, `{line.*}` deprecation documented. Update the open/blocked + fixed tables, the bundle migration note, and the **Templates updated** roll-up when slugs or scope change.*