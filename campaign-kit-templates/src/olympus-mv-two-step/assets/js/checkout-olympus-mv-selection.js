// JavaScript extracted from templates\checkout\olympus-mv-selection.html

// Content from static file: olympus-mv-selection.js
// ============================================
// CONFIGURATION SECTION
// ============================================
const CONFIG = {
  // Navigation URLs (fallback when campaign context not available)
  urls: {
    checkoutStep2: 'checkout', // fallback path; prefer meta[name="next-success-url"] from campaign
  },
...
class TierController {
  ...
  async _addToCartAndCheckout() {
    ...
    try {
      ...
      // Redirect to checkout: use campaign-built URL from meta when present
      const successMeta = document.querySelector('meta[name="next-success-url"]');
      const checkoutUrl = (successMeta && successMeta.getAttribute('content')) || CONFIG.urls.checkoutStep2;
